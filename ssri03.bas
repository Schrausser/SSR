!!
     SSR Info 03: Grössenverhältnisse im
               Sonnensystem
...
DO
 ...
 IF sw_i03=1
  ...
  GR.TEXT.DRAW tx,20,40,CHR$(8560)+" Sonnensystem: Radius - Distanz"
 ...
 IF sw_i03=2
  ...
  GR.TEXT.DRAW tx,20,40,CHR$(8560)+" Sonnensystem: Rotation - Umlauf"
  GR.LINE ln, 1,50,sx-1,50
  GR.COLOR 100,150,150,150,0
 ...
 IF sw_i03=3
  ...
  GR.TEXT.SIZE sx/25
  GR.COLOR cc-40, cc/2, cc/2, cc/2, 1
  GR.TEXT.DRAW tx,20,40,CHR$(8560)+" Sonnensystem: Masse, Grav., Vol."
  GR.LINE ln, 1,50,sx-1,50
  GR.COLOR 200,150,150,150,1
  GR.TEXT.ALIGN 1
  GR.TEXT.SIZE sx/35
