...
DO                                    %Start 
 ...
 IF ed04>0.3                          %Sonnensystem 
  ...
  GR.CIRCLE cl,mx, my-198+(1*2.3*ed04),ed04*2*((2439*1.2)/ds)
  GR.COLOR 160,c,c,c,1                  %Venus    
  GR.CIRCLE cl,mx, my-198+(1*2.4*ed04),ed04*2*(6052/ds)
  GR.COLOR c,60,60,c,1                  %Erde
  GR.CIRCLE cl,mx, my-198+(1*2.5*ed04),ed04*2*(6378/ds)
  GR.COLOR 100,c,c,c,1                  %Mond  
  GR.CIRCLE cl,mx-2*(384000/ds)*ed04, my-198+(1*2.5*ed04),ed04*2*((1738*2)/ds)
  IF ed04>139
  ...
  GR.CIRCLE cl,mx, my-198+(1*2.6*ed04),ed04*2*(3397/ds)
  GR.COLOR 120,c-20,170,0,1             %Jupiter
  GR.CIRCLE cl,mx, my-198+(1*3*ed04),ed04*2*(71000/ds)
  GR.COLOR 70,c,c,c,1                   %Saturn
  GR.CIRCLE cl,mx, my-198+(1*3.6*ed04),ed04*2*(60000/ds)
  GR.LINE ln, mx-0.4*ed04,my-198+(1*3.64*ed04), mx+0.4*ed04, my-198+(1*3.56*ed04)
  GR.COLOR 100,30,30,200,1              %Uranus
  GR.CIRCLE cl,mx, my-198+(1*4.1*ed04),ed04*2*(25400/ds)
  GR.COLOR 70,50,50,c,1                 %Neptun
  GR.CIRCLE cl,mx, my-198+(1*4.5*ed04),ed04*2*(24300/ds)
  IF ed04<100
   GR.COLOR c/2,c,c,c,1
   GR.TEXT.SIZE (18/23)*ed04
   GR.TEXT.DRAW tx, sx-20,my-198+(0.0*d*ed04) ,"Sonne"
   GR.TEXT.SIZE (11/23)*ed04
   GR.TEXT.DRAW tx, sx-20,my-198+(0.05*d*ed04) ,"r=696000km"
  ENDIF
 ENDIF
 ...
 IF ed04>0.2
  ...
  IF ed04<115
   ...
   GR.TEXT.DRAW tx, sx-20,my-200+ ((1.09*d*ed04)*((a1/a0)/dsx)) ,"r=1 190000km"
  ENDIF
 ENDIF
 ...
 IF ed04<140
  ...
  GR.TEXT.DRAW tx, sx-20,my-200+ ((2.13*d*ed04)*((a2/a0)/dsx)) ,"r=1 266200km"
 ENDIF
 ...
 IF ed04<180
  ...
  GR.TEXT.DRAW tx, sx-20,my-200+ ((3.13*d*ed04)*((a3/a0)/dsx)) ,"r=1 643200km"
 ENDIF
 ...
 IF ed04<30
  ...
  GR.TEXT.DRAW tx, sx-20,my-200+ ((4.1*d*ed04)*((a4/a0)/dsx)) ,"r=6 122000km"
 ENDIF
 ...
 IF ed04<40
  ...
  GR.TEXT.DRAW tx, sx-20,my-200+ ((5.15*d*ed04)*((a5/a0)/dsx)) ,"r=30 701000km"
 ENDIF
 ...
 IF ed04<60
  ...
  GR.TEXT.DRAW tx, sx-20,my-200+ ((6.24*d*ed04)*((a6/a0)/dsx)) ,"r=54 890000km"
 ENDIF
 ...
 IF ed04<120
  ...
  IF ed04<120
   ...
   GR.TEXT.DRAW tx, sx-20,my-200+ ((7.24*d*ed04)*((a7/a0)/dsx)) ,"r=143 230000km"
  ENDIF
 ENDIF 
 dsx=20                                %Abstandsfaktor
 GR.COLOR 35,c,c,c,1
 IF ed04<150
  ...
  GR.TEXT.DRAW tx, sx-20,my-200+ ((8.24*d*ed04)*((a8/a0)/dsx)) ,"r=264 370000km"
 ENDIF 
 ...
 IF ed04<180
  ...
  GR.TEXT.DRAW tx, sx-20,my-200+ ((9.35*d*ed04)*((a9/a0)/dsx)) ,"r=473 080000km"
 ENDIF 
 ...
 IF ed04<200
  ...
  GR.TEXT.DRAW tx, sx-20,my-200+ ((10*d*ed04)*((a10/a0)/dsx)) ,"Beteigeuze"
  GR.TEXT.SIZE (11/0.05)*ed04
  GR.TEXT.DRAW tx, sx-20,my-200+ ((10.40*d*ed04)*((a10/a0)/dsx)) ,"r=617 100000km"
 ENDIF 
 ...
 IF swv=-1                             %Vollautomatik
  IF sw=1                              %Vorwärts      
   ed04=ed04/ve
   IF ed04<sx/9000:PAUSE 3000:sw=-1:ENDIF
  ENDIF
  IF sw=-1                             %Rückwärts
   ed04=ed04*ve
 ...
 IF tc
  IF swv=1
   ...
   IF tx>mx&ty<my&ed04>sx/9000:ed04=ed04/ve:ENDIF
  ENDIF
