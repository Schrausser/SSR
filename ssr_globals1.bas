...
m_erd_kg=   5.9724 *10^24         % Masse in kg
g_erd_ms2=  9.78                  % Gravitation in m/s2
v_erd_km3=  1.083 *10^12          % Volumen in km3
d_erd_ae=d_erd_m/au_              % mittlere Distanz in AE
% Mond %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
r_mnd_km=   3475 /2               % Radius in km 
d_mnd_m=    378 *10^6             % mittlere Erd Dis. in m 
uf_mnd_t=   655.7 /24             % Erdumlaufzeit in T
m_mnd_kg=   0.07346 *10^24        % Masse in kg
g_mnd_ms2=  1.26                  % Gravitation in m/s2
...
g_mrs_ms2=  3.71                  % Gravitation in m/s2
...
uf_jpt_j=   4331 /a_              % Umlaufzeit in J
rt_jpt_=    9.9 /24               % Eigenrotation in T
m_jpt_kg=   1898.13 *10^24        % Masse in kg
g_jpt_ms2=  24.79                 % Gravitation in m/s2
...
uf_stn_j=   10747 /a_             % Umlaufzeit in J
rt_stn_=    10.7 /24              % Eigenrotation in T
m_stn_kg=   568.32 *10^24         % Masse in kg
g_stn_ms2=  10.44                 % Gravitation in m/s2
