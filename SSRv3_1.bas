...
!!
_name$="SSR"
_ver$="v3.7.28.1"       % Standard devices
INCLUDE strg_.inc
INCLUDE ssr.inc
SENSORS.OPEN 3:1        %
...
!!
 ...
 IF s09=1 % Text %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  IF s07=0                     % bei Vollsimulation
   ...
   GR.TEXT.DRAW txt,dtx4,dtx1+dtx1,"Copyright "+_cr$+" 2025 by Dietmar Gerald Schrausser"
  ENDIF
  IF s07=-1                    % bei Simulation
   GR.TEXT.ALIGN 1
...
GOSUB menu
std:
ARRAY.LOAD sel$[],o05$,o06$,o12$,o13$,o14$,o15$,o17$,o16$,o18$,o10$,o09$,o07$,"Ok",_ex$+"  Exit"
