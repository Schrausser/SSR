...
Further astronomical objects can be implemented by means of external definition files. Parts of the Caldwell Catalog (Moore & Pepin, 1995) are included as `ssr_Caldwell.dat`  
